...
function disableBtn(){
 ...
 async function WeatherCheckClick(city){
    ...
    weatherImg.src="../public/img/clear.svg"
    
    }
    if(data1.weather[0].main==="Smoke" ) {
      weatherImg.src="../public/img/snow.svg"
    }
    if(data1.weather[0].main==="Haze" ){
         weatherImg.src="../public/img/mist.svg"

    }
    if(data1.weather[0].main==="Mist" ){
        weatherImg.src="../public/img/mist.png"

   }
   if(data1.weather[0].main==="Clouds" ){
    weatherImg.src="../public/img/clouds.svg"
